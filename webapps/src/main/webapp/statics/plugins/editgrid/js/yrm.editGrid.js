    ...
    * */
    ...
    cmpFn["operateBtn"] = $.extend({},{
        setDisplayStateBtn: function (obj) {
            var editBtn=$('<a href="javascript:void(0);" class="a-icon a-edit" id="edit" title="编辑"/>'),
    ...
    $.extend(GridShowObj.prototype, {
        ...
        _initHeadTh: function () {
            ...
            if(config.operateCol){
                ...
                if(config.addBtn){
                    var addBtn=$("<a href='javascript:void(0);' class='a-icon a-add imgAdd' id='add' title='增加'/></a>");
